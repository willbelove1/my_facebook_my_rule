 ...
 * Phiên bản: 2.0.3 (Thêm light mode và các tính năng từ enhanced)
 */
(function() {
  'use strict';
...
const initUI = async () => {
  ...
  try {
    ...
    try {
      ...
      if (!popupEl) {
        console.error('[UIManager] Popup fbcmf-settings-popup không tồn tại sau khi thêm');
        return;
      }
      const inputs = {
        'fbcmf-blockSponsored': settings.blockSponsored,
